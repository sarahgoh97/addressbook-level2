...
public class StorageFileTest {
    ...
    public void load_validFormat() throws Exception {
        ...
        final String actual = actualAB.getAllPersons().toString();
        final String expected = expectedAB.getAllPersons().toString();
